...
show databases;
create database if not exists ineuron_que;
show databases;
use ineuron_que;
...
(44,"technician","single","secondary","no",29,"yes","no","unknown",5,"may",151,1,-1,0,"unknown","no"),
 ...
 select * from bank_details where age = 33 and age = 60;
 select * from bank_details where age = 33 or age = 60;
...
-- with this data
-- 1.Try to fine out sum of balance 
